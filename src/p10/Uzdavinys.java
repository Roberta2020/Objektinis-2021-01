...
public class Uzdavinys {
    ...
    static void mapTest(Map<String, Zmogus> zmones) {
        ...
        zmones.put("222", new Zmogus("V2", "P2", "222"));
    ...
    static void MapTest2(Map<String, List<Zmogus>> zmones) {
        ...
        addMapTest2("333", new Zmogus("V3", "P3", "333"));
        addMapTest2("111", new Zmogus("V11", "P11", "111"));
        addMapTest2("222", new Zmogus("V2", "P2", "222"));
        addMapTest2("228", new Zmogus("V28", "P28", "228"));
        addMapTest2("111", new Zmogus("V110", "P110", "111"));
    }

    System.out.println("Reiksmes: ");
        for(
    List<Zmogus> z :zmones.values())
